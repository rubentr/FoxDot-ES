...
Returns the original pattern with mirrored version of itself appended. a removes values from the middle of the pattern, if positive. b 

removes values from the end of the pattern, should be negative.

e.g.
   P[:4].palindrome() P[0, 1, 2, 3, 3, 2, 1, 0] P[:4].palindrome(1) P[0, 1, 2, 3, 2, 1, 0] P[:4].palindrome(-1) P[0, 1, 2, 3, 3, 2, 1] 
